...
func ReleaseResponseReasonParse(value string) (ReleaseResponseReason, error) {
	...
	case strings.EqualFold(value, "NotFinished"):
...
// AllReleaseResponseReason returns a slice containing all defined ReleaseResponseReason values.
func AllReleaseResponseReason() []ReleaseResponseReason {
	return []ReleaseResponseReason{
		ReleaseResponseReasonNormal,
		ReleaseResponseReasonNotFinished,
		ReleaseResponseReasonUserDefined,
	}
}
