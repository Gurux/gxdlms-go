...
// GXNeighborDiscoverySetup defines neighbor discovery setup values for GXDLMSIp6Setup.
// Te configuration to be used for both routers and hosts to support the Neighbor Discovery protocol for IPv6.
