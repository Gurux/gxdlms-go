...
type PppSetupIPCompressionProtocol int

const (
	// PppSetupIPCompressionProtocolNone defines that the no IP Compression is used (default).
...
// PppSetupIPCompressionProtocolParse converts the given string into a PppSetupIPCompressionProtocol value.
//
// It returns the corresponding PppSetupIPCompressionProtocol constant if the string matches
...
// String returns the canonical name of the PppSetupIPCompressionProtocol.
// It satisfies fmt.Stringer.
func (g PppSetupIPCompressionProtocol) String() string {
	var ret string
	switch g {
